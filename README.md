...
on how changes to their code affect energy efficiency. We thank you for working on this, and apologize for any snags encountered -- the tools are very cutting edge, and doing very advanced code things, so we it is wise to expect a few snags along the way. We are here to help -- please contact us if you are encountering unexpected issues.
